...
Menu: 1-Add 2-Delete 3-Update 4-Search 5-Display(asc) 6-Display(desc) 7-Analyze 8-Exit
Choice: 1
Keyword: apple
Meaning: A fruit
Keyword 'apple' inserted/updated with 0 comparisons.

Menu: 1-Add 2-Delete 3-Update 4-Search 5-Display(asc) 6-Display(desc) 7-Analyze 8-Exit
Choice: 1
Keyword: banana
Meaning: Another fruit
Keyword 'banana' inserted/updated with 1 comparisons.
...
AVL Tree Analysis:
Height: 2, Nodes: 2
Max comparisons: 2, Theoretical max height: 3
